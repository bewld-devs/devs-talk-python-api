...
class Profile(models.Model):
    ...
    avatar = CloudinaryField('image', null=True, default='https://res.cloudinary.com/bewld-devs/image/upload/v1668100394/devs-talk-python-api-avatars/user_ffxusf.jpg', folder='devs-talk-python-api-avatars')
    cover_photo = CloudinaryField('image', null=True, default='', folder='devs-talk-python-api-cover-photos')
