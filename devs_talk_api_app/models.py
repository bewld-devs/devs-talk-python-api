...
class Profile(models.Model):
    ...
    avatar = CloudinaryField('image', null=True, default='media/default.jpg', folder='devs-talk-python-api-avatars')
    cover_photo = CloudinaryField('image', null=True, default='media/default.jpg', folder='devs-talk-python-api-cover-photos')
